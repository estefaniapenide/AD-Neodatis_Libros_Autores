...
//No es necesario pero puede servir para hacer pruebas
    /**
    ...
    public static void main(String[] args) {
        ...
        Libro libro2 = new Libro(2,"SIN TÍTULO 2","AVENTURAS",21.99f,new Date(2020-1900, 12-1, 13));
        autor2.getLibros().add(libro2);
        
        Autor autor3 = new Autor("24060524V","AUTOR3","CALLE SINNOMBRE Nº3",45,"ITALIANA");
        Libro libro4 = new Libro(4,"SIN TÍTULO 4","AVENTURAS",21.99f,new Date(2020-1900, 12-1, 13));
        ...
        Libro libro6 = new Libro(6,"SIN TÍTULO 6","AVENTURAS",21.99f,new Date(2020-1900, 12-1, 13));
